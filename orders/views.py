...
class OrderDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = f'Parfenovka Store | Заказ № {self.object.id}'
        return context
...
class OrderCreateView(CommonContextMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        checkout_session = stripe.checkout.Session.create(
            ...
            mode='payment',
            success_url=settings.DOMAIN_NAME + reverse_lazy('orders:success'),
            cancel_url=settings.DOMAIN_NAME + reverse_lazy('orders:canceled'),
        )
